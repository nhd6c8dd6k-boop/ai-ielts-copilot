...
export const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.pro.feature.support": "Support the project and receive Pro membership",
  ...
  zh: {
    ...
    "pricing.pro.feature.membership": "Pro 会员身份",
    "pricing.pro.feature.support": "支持项目并获得 Pro 会员",
