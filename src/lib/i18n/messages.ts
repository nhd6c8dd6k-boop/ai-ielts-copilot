...
export const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.accountability.eyebrow": "7-day accountability",
    "dashboard.accountability.loadingTitle": "Loading 7-day beta",
    "dashboard.accountability.loadingDescription":
      "Checking your accountability beta status.",
    "dashboard.accountability.loggedOutTitle": "Join the 7-day IELTS beta",
    ...
    "dashboard.accountability.joinTitle":
      "Try the 7-day IELTS accountability beta",
    ...
    "dashboard.accountability.waitlistTitle": "You are on the beta waitlist",
    ...
    "dashboard.accountability.completedTitle": "7-day beta completed",
    "dashboard.accountability.completedDescription":
      "Review your completed tasks or submit beta feedback.",
    "dashboard.accountability.activeTitle": "Today’s IELTS task",
    "dashboard.accountability.activeDescription":
      "Open your 7-day plan to continue today’s practice.",
    "dashboard.accountability.progress": "{completed}/7 completed",
    "dashboard.accountability.day": "Day {day}",
    "dashboard.accountability.login": "Log in to join",
    "dashboard.accountability.startTask": "Start task",
    "dashboard.accountability.openPlan": "Open plan",
    "dashboard.accountability.viewPlan": "View plan",
    "accountability.eyebrow": "Accountability Beta",
    "accountability.title": "7-Day IELTS Accountability Beta",
    "accountability.description":
      "Join a small beta group and follow one focused IELTS practice task per day for 7 days.",
    "accountability.disabled.title": "Beta is not open yet",
    "accountability.disabled.description":
      "The 7-day accountability beta is currently closed.",
    "accountability.error.generic": "Something went wrong.",
    "accountability.loginCta": "Log in to join",
    "accountability.registerCta": "Create account",
    "accountability.intro.title": "Stay consistent for 7 days",
    ...
    "accountability.intro.focus.title": "One focused IELTS task per day",
    "accountability.intro.focus.text":
      "The plan uses your weakest skill to choose a steady 7-day practice path.",
    "accountability.intro.capacity.title": "Limited to 10 active students",
    "accountability.intro.capacity.text":
      "If the beta is full, you can join the waitlist and be activated manually.",
    "accountability.intro.reminder.title": "Manual reminder support",
    "accountability.intro.reminder.text":
      "Choose Crisp, email, or no reminder. Messages are sent manually by the admin.",
    "accountability.form.title": "Join the beta",
    "accountability.form.description":
      "Answer a few questions so we can generate your 7-day plan.",
    "accountability.form.targetBand": "Target band",
    "accountability.form.weakestSkill": "Weakest skill",
    "accountability.form.dailyMinutes": "Daily time",
    "accountability.form.reminder": "Reminder",
    "accountability.form.noExamDate": "I haven’t booked my exam yet",
    "accountability.form.examDate": "Exam date",
    "accountability.form.examDateRequired":
      "Choose an exam date or select that you have not booked yet.",
    "accountability.form.submit": "Join 7-day beta",
    "accountability.reminder.none": "No reminder",
    "accountability.minutes": "{minutes} minutes",
    "accountability.status.waitlisted": "Waitlisted",
    "accountability.status.active": "Active",
    "accountability.status.completed": "Completed",
    "accountability.status.withdrawn": "Withdrawn",
    "accountability.skill.writing": "Writing",
    "accountability.skill.reading": "Reading",
    "accountability.skill.listening": "Listening",
    "accountability.skill.speaking": "Speaking",
    "accountability.skill.review": "Review",
    "accountability.skill.not_sure": "Not sure",
    "accountability.taskStatus.completed": "Completed",
    "accountability.taskStatus.today": "Today",
    "accountability.taskStatus.available": "Available",
    "accountability.taskStatus.upcoming": "Upcoming",
    "accountability.dayCount": "Day {day} of 7",
    "accountability.day": "Day {day}",
    "accountability.progress": "{completed}/7 completed",
    "accountability.today": "Today’s task",
    "accountability.startTask": "Start task",
    "accountability.openTask": "Open",
    "accountability.markComplete": "Mark complete",
    "accountability.withdraw": "Withdraw",
    "accountability.withdrawConfirm": "Withdraw from this beta plan?",
    "accountability.waitlist.title": "You are on the waitlist",
    "accountability.waitlist.description":
      "The active beta group is full. We will activate you manually when a spot opens.",
    "accountability.completed.title": "7-day beta completed",
    "accountability.completed.description":
      "Thanks for completing the beta. Your feedback helps improve the next version.",
    "accountability.plan.title": "Your 7-day plan",
    "accountability.tasks.title": "Your 7-day task list",
    "accountability.feedback.title": "Beta feedback",
    "accountability.feedback.description":
      "Tell us what helped and what should change before the next beta.",
    "accountability.feedback.submitted": "Thanks, your feedback has been saved.",
    "accountability.feedback.rating": "Rating",
    "accountability.feedback.helpedMost": "What helped most?",
    "accountability.feedback.difficulty": "What was difficult?",
    "accountability.feedback.willingness": "Would you join another beta?",
    "accountability.feedback.yes": "Yes",
    "accountability.feedback.maybe": "Maybe",
    "accountability.feedback.no": "No",
    "accountability.feedback.submit": "Submit feedback",
  ...
  zh: {
    ...
    "dashboard.accountability.eyebrow": "7 天督促",
    "dashboard.accountability.loadingTitle": "正在加载 7 天 Beta",
    "dashboard.accountability.loadingDescription": "正在检查你的 Beta 状态。",
    "dashboard.accountability.loggedOutTitle": "加入 7 天 IELTS Beta",
    "dashboard.accountability.loggedOutDescription":
      "登录后加入小规模 IELTS 学习督促，每天完成一个聚焦任务。",
    "dashboard.accountability.joinTitle": "试试 7 天 IELTS 学习督促 Beta",
    "dashboard.accountability.joinDescription":
      "一个轻量 7 天计划，支持人工提醒。active 名额限 10 人。",
    "dashboard.accountability.waitlistTitle": "你已进入 Beta 等待名单",
    "dashboard.accountability.waitlistDescription":
      "当前 active 名额已满。有空位时管理员会手动激活你。",
    "dashboard.accountability.completedTitle": "7 天 Beta 已完成",
    "dashboard.accountability.completedDescription":
      "查看已完成任务，或提交 Beta 反馈。",
    "dashboard.accountability.activeTitle": "今天的 IELTS 任务",
    "dashboard.accountability.activeDescription": "打开 7 天计划，继续今天的练习。",
    "dashboard.accountability.progress": "已完成 {completed}/7",
    "dashboard.accountability.day": "第 {day} 天",
    "dashboard.accountability.login": "登录后加入",
    "dashboard.accountability.startTask": "开始任务",
    "dashboard.accountability.openPlan": "打开计划",
    "dashboard.accountability.viewPlan": "查看计划",
    "accountability.eyebrow": "学习督促 Beta",
    "accountability.title": "7 天 IELTS 学习督促 Beta",
    "accountability.description":
      "加入小规模 Beta，用 7 天每天完成一个聚焦 IELTS 练习任务。",
    "accountability.disabled.title": "Beta 暂未开放",
    "accountability.disabled.description": "7 天学习督促 Beta 当前未开放。",
    "accountability.error.generic": "操作失败，请稍后再试。",
    "accountability.loginCta": "登录后加入",
    "accountability.registerCta": "创建账号",
    "accountability.intro.title": "连续 7 天保持练习",
    "accountability.intro.description":
      "这是一个小规模学习督促 Beta，不是 AI Coach。任务仍然使用现有 IELTS 练习页面，并遵守当前 Free / Pro 使用限制。",
    "accountability.intro.focus.title": "每天一个聚焦 IELTS 任务",
    "accountability.intro.focus.text":
      "系统会根据你的薄弱项生成稳定的 7 天练习路径。",
    "accountability.intro.capacity.title": "active 学员限 10 人",
    "accountability.intro.capacity.text":
      "如果 Beta 名额已满，你可以加入等待名单，由管理员手动激活。",
    "accountability.intro.reminder.title": "人工提醒支持",
    "accountability.intro.reminder.text":
      "可选择 Crisp、email 或不提醒。提醒由管理员手动发送。",
    "accountability.form.title": "加入 Beta",
    "accountability.form.description": "回答几个问题，我们会生成你的 7 天计划。",
    "accountability.form.targetBand": "目标分数",
    "accountability.form.weakestSkill": "最薄弱科目",
    "accountability.form.dailyMinutes": "每日时间",
    "accountability.form.reminder": "提醒方式",
    "accountability.form.noExamDate": "我还没有预约考试",
    "accountability.form.examDate": "考试日期",
    "accountability.form.examDateRequired": "请选择考试日期，或勾选尚未预约。",
    "accountability.form.submit": "加入 7 天 Beta",
    "accountability.reminder.none": "不提醒",
    "accountability.minutes": "{minutes} 分钟",
    "accountability.status.waitlisted": "等待中",
    "accountability.status.active": "进行中",
    "accountability.status.completed": "已完成",
    "accountability.status.withdrawn": "已退出",
    "accountability.skill.writing": "Writing",
    "accountability.skill.reading": "Reading",
    "accountability.skill.listening": "Listening",
    "accountability.skill.speaking": "Speaking",
    "accountability.skill.review": "复盘",
    "accountability.skill.not_sure": "不确定",
    "accountability.taskStatus.completed": "已完成",
    "accountability.taskStatus.today": "今天",
    "accountability.taskStatus.available": "可完成",
    "accountability.taskStatus.upcoming": "未解锁",
    "accountability.dayCount": "第 {day} / 7 天",
    "accountability.day": "第 {day} 天",
    "accountability.progress": "已完成 {completed}/7",
    "accountability.today": "今天的任务",
    "accountability.startTask": "开始任务",
    "accountability.openTask": "打开",
    "accountability.markComplete": "标记完成",
    "accountability.withdraw": "退出",
    "accountability.withdrawConfirm": "确定退出这个 Beta 计划吗？",
    "accountability.waitlist.title": "你已进入等待名单",
    "accountability.waitlist.description":
      "当前 active 名额已满。有空位时管理员会手动激活你。",
    "accountability.completed.title": "7 天 Beta 已完成",
    "accountability.completed.description":
      "感谢你完成 Beta。你的反馈会帮助我们改进下一版。",
    "accountability.plan.title": "你的 7 天计划",
    "accountability.tasks.title": "你的 7 天任务列表",
    "accountability.feedback.title": "Beta 反馈",
    "accountability.feedback.description":
      "告诉我们哪些部分有帮助，以及下一版应该改什么。",
    "accountability.feedback.submitted": "谢谢，你的反馈已保存。",
    "accountability.feedback.rating": "评分",
    "accountability.feedback.helpedMost": "最有帮助的是什么？",
    "accountability.feedback.difficulty": "哪里比较困难？",
    "accountability.feedback.willingness": "你愿意参加下一次 Beta 吗？",
    "accountability.feedback.yes": "愿意",
    "accountability.feedback.maybe": "可能",
    "accountability.feedback.no": "不愿意",
    "accountability.feedback.submit": "提交反馈",
